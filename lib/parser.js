...
const types = {
    ...
    any: new BaseSchema( parseSchema, 'any' ),

    string: new StringSchema( parseSchema ),

    number: new BaseSchema( parseSchema, 'number' ),

    boolean: new BaseSchema( parseSchema, 'boolean' ),

    date: new BaseSchema( parseSchema, 'date' ),

    binary: new BaseSchema( parseSchema, 'binary' ),

    email: new EmailSchema( parseSchema ),

    uuid: new UUIDSchema( parseSchema ),
